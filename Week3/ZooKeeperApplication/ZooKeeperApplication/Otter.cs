...
{
    public class Otter : Animal, ITrainable
    {
        ...
        public Otter() : base("Otter", "Urchin & Mussels")
        {
            //Species = "Otter";
            //_treat = "Urchin & Mussels";
        }

        public override string MakeNoise()
        {
            string otterNoise = $"The otter curls up to you and goes \"Eeeeiiiieee\". ";
            return otterNoise;
        }
