...
{
    public class Orca : Animal, ITrainable
    {
        ...
        public Orca() :base ("Orca", "Fish")
        {
        }

        public override string MakeNoise()
        {
            string OrcaNoise = $"\"Spraaayyyyyyyy.\" The orca blows water at you from its blowhole and goes \"aaaiiiiiegh\".";
            return OrcaNoise;
        }
